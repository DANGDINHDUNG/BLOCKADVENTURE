...
public class LineIndicator : MonoBehaviour
{
    ...
    #region Methods
    private (int, int) GetSquareSquareIndex(int square_index)
    {
        int pos_row = -1;
        int pos_col = -1;
    ...
    public int[] GetVerticleLine(int square_index)
    {
        int[] line = new int[9];

        var square_pos_col = GetSquareSquareIndex(square_index).Item2;
